    ...
    <div id='faq' className='block faqBlock'>
      <div className='container-fluid'>
        <div className='titleHolder'>
          ...
          <p>Get answer of all frequently ask question.</p>
        </div>
        ...
        <div className='quickSupport'>
          ...
          <p>
            We are capabile of auditing existing technology and websites and
            then offer options to strengthen the online capabilities of
            organizations and businesses. Our work including web programming,
